...
#SBATCH -o /ghome/group07/MCV-C5-Group7/ultralytics/output/task_d/%x_%u_%j.out # File to which STDOUT will be written
#SBATCH -e /ghome/group07/MCV-C5-Group7/ultralytics/output/task_d/%x_%u_%j.err # File to which STDERR will be written
sleep 5
source /ghome/group07/miniconda3/etc/profile.d/conda.sh
conda activate c5
cd /ghome/group07/MCV-C5-Group7/ultralytics/output/task_d
python /ghome/group07/MCV-C5-Group7/ultralytics/task_d/task_d.py