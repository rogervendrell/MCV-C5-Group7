...
#SBATCH -o /ghome/group07/MCV-C5-Group7/Week3/1-baseline-subwordlevel/output/%x_%u_%A_%a.out
#SBATCH -e /ghome/group07/MCV-C5-Group7/Week3/1-baseline-subwordlevel/output/%x_%u_%A_%a.err
