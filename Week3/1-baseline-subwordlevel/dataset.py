...
class VizWizDataset(Dataset):
    ...
    caption_tensor is one randomly chosen caption encoded as subword IDs.
    """

    def __init__(self, samples: list[dict], img_path: str, max_len: int = tok.TEXT_MAX_LEN):
    ...
    def encode_caption(self, caption: str) -> torch.Tensor:
        indices = tok.encode(caption, max_len=self.max_len)
