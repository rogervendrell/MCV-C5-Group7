...
#SBATCH -J eval_attention         # Job name
...
python /ghome/group07/MCV-C5-Group7/Week3/5-attention/main.py --eval-only --load-weights /ghome/group07/MCV-C5-Group7/Week3/5-attention/results/weights/best_model.pt
