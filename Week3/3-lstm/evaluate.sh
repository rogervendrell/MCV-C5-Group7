...
python /ghome/group07/MCV-C5-Group7/Week3/3-decoder/main.py --eval-only --load-weights /ghome/group07/MCV-C5-Group7/Week3/1-baseline/results/weights/best_model.pt
